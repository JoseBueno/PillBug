...
public class Metadata
{
    ...
    public String getDb_published_date ()
    {
        return db_published_date;
    }

    public void setDb_published_date (String db_published_date)
    {
        this.db_published_date = db_published_date;
    }
    ...
    {
        return "ClassPojo [next_page_url = "+next_page_url+", previous_page_url = "+previous_page_url+", elements_per_page = "+elements_per_page+", previous_page = "+previous_page+", total_elements = "+total_elements+", current_url = "+current_url+", total_pages = "+total_pages+", next_page = "+next_page+", db_published_date = "+db_published_date+", current_page = "+current_page+"]";
    }
}
